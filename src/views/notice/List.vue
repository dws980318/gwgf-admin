...
<!--            </el-form-item>-->
            <el-form-item label="">
              <el-input size="small" v-model="searchData.name" placeholder="请输入通知标题"></el-input>
            </el-form-item>
            <el-form-item>
              <el-select size="small" v-model="searchData.department" clearable placeholder="请选择发布类型">
