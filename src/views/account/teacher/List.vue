...
<!--            </el-form-item>-->
            <el-form-item label="">
              <el-input size="small" v-model="searchData.name" placeholder="请输入用户名、姓名..."></el-input>
            </el-form-item>
            <!--            <el-form-item>-->
...
<!--            </el-table-column>-->
            ...
            <el-table-column label="联系方式（邮件/电话号码）" align="center">
              <template slot-scope="scope">
            ...
            <el-table-column label="所在中心" align="center">
              <template slot-scope="scope">
            ...
            <el-table-column label="操作" fixed="right" width="250px" align="center">
              <template slot-scope="scope">
                <el-button size="mini" type="warning" @click="handleEditPassword(scope.$index, scope.row.id)">重置密码</el-button>
...
<script>
  export default {
    ...
    methods: {
      ...
      hanldeAdd() {  // 添加
        this.$router.push('/account/teacher/add')
      },
      showModal() {
        this.visible = true
      },
