...
<!--            </el-form-item>-->
            <el-form-item label="">
              <el-input size="small" v-model="searchData.name" placeholder="请输入日志名称"></el-input>
            </el-form-item>
            <el-form-item label="">
...
<!--            </el-table-column>-->
            <el-table-column label="操作" fixed="right" width="100px" align="center">
              <template slot-scope="scope">
<!--                <el-button size="mini" type="primary" @click="handleEdit(scope.$index, scope.row.id)">查看详情</el-button>-->
        ...
        let newData = [
          {
            ...
            user: '王小虎',
            class: '系统操作',
            controller: 'http:192.168.0.183/#/notice/add',
